...
<head>
  ...
  <title>Akmal Dafa Adyatma - A12.2022.06812</title>
  ...
  <aside class="aside is-placed-left is-expanded">
    <div class="aside-tools">
      <div class="aside-tools-label">
        <span><b>Akmal Dafa Adyatma</b> A12.2022.06812</span>
      </div>
    </div>
    <div class="menu is-menu-main">
      <p class="menu-label">_______</p>
      <ul class="menu-list">
        <li>
          <a href="profile.html" class="is-active router-link-active has-icon">
